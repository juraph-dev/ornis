...
void TopicStringViewer::drawStrings()
{
  ...
  if (!data_buffer_.filled_)
  {
    ...
    {
      uint64_t bgchannels = NCCHANNELS_INITIALIZER((int)(255 - r_step_ * (data_buffer_.i_ - i)),
                                                   (int)(255 - g_step_ * (data_buffer_.i_ - i)),
  ...
  else
  {
    ...
    {
      uint64_t bgchannels = NCCHANNELS_INITIALIZER((int)(32 + r_step_ * (i - data_buffer_.i_ + 2)),
