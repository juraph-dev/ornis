  ...
  const rosidl_typesupport_introspection_cpp::MessageMembers * members, uint8_t * data)
{
  ...
  if (!entry_path_.empty()) {
    ...
    desired_member = static_cast<const rosidl_typesupport_introspection_cpp::MessageMembers *>(
  ...
  msg_tree::msg_contents topic_contents = {
    .data_type_ = "", .entry_name_ = "topic", .entry_data_ = ""};

  auto typesupport = introspection::getMessageTypeSupport(
    topic_char, rosidl_typesupport_introspection_cpp::typesupport_identifier);
